# Учебный проект по сайту квестов

ТЗ: нужно было реализовать главную страницу сайта, описание квеста и заполнение формы. 
Проект реализован на js при помощи библиотеки react. Проект отрисован с помощью функциональных компонентов с применением хуков.
